"""Hairball CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.hairball/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Hairball Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ฅ"              # Shown on exit
      response_label: " ฅ Hairball "       # Response box header label
...
.. code-block:: python
    ...
    from hairball_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Hairball Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.hairball/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic Hairball gold/kawaii (the current look)
...
Drop a YAML file in ``~/.hairball/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces HAIRBALL_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces HAIRBALL_CAT_HERO)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Hairball — gold and kawaii",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Hairball Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ฅ",
            "response_label": " ฅ Hairball ",
            "prompt_symbol": "❯",
...
def _skins_dir() -> Path:
    ...
    return get_hairball_home() / "skins"
...
def get_active_goodbye(fallback: str = "Goodbye! ฅ") -> str:
