...
How it fits the existing auth framework:
  ...
  * :func:`token_auth_middleware` runs OUTERMOST (installed last in
    ...
    :class:`~hairball_cli.dashboard_auth.base.TokenPrincipal` to
...
from hairball_cli.dashboard_auth import list_token_providers
from hairball_cli.dashboard_auth.audit import AuditEvent, audit_log
from hairball_cli.dashboard_auth.base import ProviderError, TokenPrincipal
