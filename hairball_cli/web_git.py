"""Backend git operations for the desktop coding rail + session-style review pane.
...
def worktree_add(cwd: str, options: dict) -> dict:
    ...
    branch = _sanitize_branch(options.get("branch") or "") or f"hairball/{slug}"
