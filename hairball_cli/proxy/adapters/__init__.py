...
from hairball_cli.proxy.adapters.base import UpstreamAdapter
from hairball_cli.proxy.adapters.managed_portal import ManagedPortalAdapter
from hairball_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``hairball proxy start --provider <name>`` CLI flag.
ADAPTERS: Dict[str, Type[UpstreamAdapter]] = {
    "managed": ManagedPortalAdapter,
    "xai": XAIGrokAdapter,
}
