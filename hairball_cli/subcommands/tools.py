"""``hairball tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'hairball tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # hairball tools list [--platform cli]
    ...
    # hairball tools disable <name...> [--platform cli]
    ...
    # hairball tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `hairball tools` runs after you pick a provider that\n"
