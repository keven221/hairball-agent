...
Entry point: ``hairball whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``hairball_cli/main.py``).
...
Hairball gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print()
    print("ฅ WhatsApp Business Cloud API Setup")
    print("=" * 50)
    print()
    print("This wizard configures Hairball to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Hairball needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Hairball gateway in another terminal:")
    print("         hairball gateway")
    print()
