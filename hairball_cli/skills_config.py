"""
Skills configuration for Hairball Agent.
`hairball skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.hairball/config.yaml under:
...
from hairball_cli.config import cfg_get, load_config, save_config
from hairball_cli.colors import Colors, color
from hairball_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `hairball skills`."""
    from hairball_cli.curses_ui import curses_checklist
