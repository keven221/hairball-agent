...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_hairball_agent_browser()
    ),
...
def _has_hairball_agent_browser() -> bool:
    ...
    # install.sh installs globally into $HAIRBALL_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-HairballHome", str(get_hairball_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = hairball_subprocess_env(inherit_credentials=False)
