...
Usage:
    hairball pairing list              # Show all pending + approved users
    hairball pairing approve <platform> <code>  # Approve a pairing code
    hairball pairing revoke <platform> <user_id> # Revoke user access
    hairball pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle hairball pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: hairball pairing {list|approve|revoke|clear-pending}")
        print("Run 'hairball pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.hairball/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'hairball pairing list' to see pending codes.\n")
