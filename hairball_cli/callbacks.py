...
into prompt_toolkit's event loop. Each function takes the HairballCLI instance
...
from hairball_cli.banner import cprint, _DIM, _RST
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.hairball/.env and never exposed to the model.
    """
