...
author: Hairball Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT)
metadata:
  hairball:
...
# $HAIRBALL_OSINT_CACHE/icij/ (default: ~/.cache/hairball-osint/icij/).
...
# Set HAIRBALL_OSINT_UA=your-app/1.0 (your@email) to identify yourself
