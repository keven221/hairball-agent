...
DEFAULT_UA = (
    "hairball-osint-investigation/0.2 "
    "(+https://github.com/managed/hairball-agent; "
    "set HAIRBALL_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("HAIRBALL_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
