...
4. Name the token (e.g., "Hairball Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${HAIRBALL_HOME:-~/.hairball}/.env`:
...
```bash
CANVAS="python $HAIRBALL_HOME/skills/productivity/canvas/scripts/canvas_api.py"
