...
Data file: $HAIRBALL_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_HAIRBALL_HOME = Path(os.environ.get("HAIRBALL_HOME", Path.home() / ".hairball"))
DATA_DIR = _HAIRBALL_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
