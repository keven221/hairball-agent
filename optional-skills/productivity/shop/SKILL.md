...
version: 1.0.1
author: Joe Rinaldi Johnson (joerj123), Hairball Agent
license: MIT
...
| Telegram (Hairball Agent + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
