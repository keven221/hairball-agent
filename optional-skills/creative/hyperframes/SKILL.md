...
```bash
bash "$(dirname "$(find ~/.hairball/skills -path '*/hyperframes/SKILL.md' 2>/dev/null | head -1)")/scripts/setup.sh"
```
...
- [troubleshooting.md](references/troubleshooting.md) — legacy fix, env vars, common render errors
