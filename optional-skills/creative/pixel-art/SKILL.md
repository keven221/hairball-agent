...
```python
import sys
sys.path.insert(0, "/home/teknium/.hairball/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.hairball/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Hairball installs package this)
