...
- User wants **Hairball itself to drive a browser** → use Hairball' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
