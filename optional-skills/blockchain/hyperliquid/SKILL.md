...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Hairball Agent
license: MIT
...
The script reads `${HAIRBALL_HOME:-~/.hairball}/.env` for two optional defaults:
...
Helper script: `~/.hairball/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.hairball/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${HAIRBALL_HOME:-~/.hairball}/.env`.
...
```bash
python3 ~/.hairball/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.hairball/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
