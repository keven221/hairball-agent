...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Hairball Agent
license: MIT
...
Helper script path: `~/.hairball/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.hairball/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.hairball/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.hairball/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
