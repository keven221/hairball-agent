...
version: 0.1.0
author: Mibay (Mibayy), Hairball Agent
license: MIT
...
```
SCRIPT=~/.hairball/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.hairball/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
