...
```bash
python3 -m pyfiglet "HAIRBALL" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=HAIRBALL&font=Slant" | boxes -d stone
```
