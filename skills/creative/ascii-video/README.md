...
Built for [Hairball Agent](hairball-agent). Usable in any coding agent. Canonical source lives here; synced to [`hairball-agent/hairball-agent/skills/creative/ascii-video`](hairball-agent) via PR.
