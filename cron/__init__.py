"""
Cron job scheduling system for Hairball Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    hairball gateway install    # Install as a user service
    sudo hairball gateway install --system  # Linux servers: boot-time system service
    hairball gateway            # Or run in foreground
