...
from hairball_cli.models import validate_requested_model
...
class TestMiniMaxModelValidation:
    ...
    def _isolate_minimax(self):
        ...
        with patch("hairball_cli.models.fetch_api_models", return_value=None), \
             patch("hairball_cli.models.probe_api_models", return_value=probe_payload):
            yield
