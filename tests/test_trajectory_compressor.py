...
def test_import_loads_env_from_hairball_home(tmp_path, monkeypatch):
    home = tmp_path / ".hairball"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-hairball-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-hairball-home"
