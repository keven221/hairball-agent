"""Session <-> workspace grouping key (hairball_state.workspace_key).

The key is what `hairball sessions list --workspace` groups/filters on. It is a
...
from hairball_state import workspace_key
