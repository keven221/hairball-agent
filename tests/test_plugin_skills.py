...
- hairball_cli/plugins register_skill API + registry
...
class TestPluginSkillRegistry:
    ...
    def pm(self, monkeypatch):
        from hairball_cli import plugins as plugins_mod
        from hairball_cli.plugins import PluginManager
...
class TestPluginContextRegisterSkill:
    ...
    def ctx(self, tmp_path, monkeypatch):
        from hairball_cli import plugins as plugins_mod
        from hairball_cli.plugins import PluginContext, PluginManager, PluginManifest
...
class TestSkillViewQualifiedName:
    ...
    def _isolate(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("HAIRBALL_HOME", str(tmp_path / ".hairball"))
...
class TestSkillViewPluginGuards:
    ...
    def test_disabled_plugin(self, tmp_path, monkeypatch):
        ...
        self._reg(tmp_path, "---\nname: foo\n---\nBody.\n")
        monkeypatch.setattr("hairball_cli.plugins._get_disabled_plugins", lambda: {"myplugin"})
