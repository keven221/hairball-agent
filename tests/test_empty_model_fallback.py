...
class TestGetDefaultModelForProvider:
    """Unit tests for hairball_cli.models.get_default_model_for_provider."""
    ...
    def test_managed_silent_default_is_not_the_expensive_flagship(self):
        """Managed Portal is a metered aggregator whose curated list is ordered
    ...
    def test_override_falls_back_to_catalog_when_missing(self):
        ...
        from hairball_cli import models as models_mod
