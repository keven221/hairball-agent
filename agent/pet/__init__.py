...
``spritesheet.{webp,png}`` of 192×208 px cells. Current reference/petdex sheets use
an 8-column × 9-row atlas; older Hairball/petdex sheets used an 8-row atlas.
Hairball infers the row taxonomy from the sheet and maps agent activity onto
...
- :mod:`agent.pet.store`     — install / list / resolve pets on disk
                               (profile-aware via ``get_hairball_home()``).
