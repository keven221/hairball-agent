...
providers (OpenRouter, managed, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Hairball/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Hairball'
    ...
    # is stricter (low/high). Clamp Hairball' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - reference Responses API fields: ``codex_reasoning_items`` /
        ...
        - Hairball-internal scaffolding markers — any top-level message key
        ...
        for msg_idx, msg in enumerate(messages):
            ...
            # Drop all Hairball-internal scaffolding markers (``_``-prefixed).
    ...
    def build_kwargs(
        ...
        **params,
        ...
        params (all optional):
            ...
            # Claude on OpenRouter/managed max output
            anthropic_max_output: int | None
            extra_body_additions: dict | None
        """
        # reference sanitization: drop reasoning_items / call_id / response_item_id.
        ...
        # Developer role swap for GPT-5/reference models
        ...
        if tools:
            ...
            # tool parameters here keeps aggregator routes (managed, OpenRouter,
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        if extra_body:
            ...
            # This happens when a profile that emits extra_body (e.g. the managed
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        # Bedrock (e.g. Managed Portal) surface a Claude refusal this way — or via
