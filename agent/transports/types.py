...
class ToolCall:
    ...
    * reference: ``{"call_id": "call_XXX", "response_item_id": "fc_XXX"}``
    ...
    * Others: ``None``
    ...
    def call_id(self) -> str | None:
        """reference call_id from provider_data, accessed via getattr by _build_assistant_message."""
        return (self.provider_data or {}).get("call_id")

    @property
    def response_item_id(self) -> str | None:
        """reference response_item_id from provider_data."""
...
class NormalizedResponse:
    ...
    * reference: ``{"codex_reasoning_items": [...], "codex_message_items": [...]}``
    * Others: ``None``
    """
