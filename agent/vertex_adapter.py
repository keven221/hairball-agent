"""Vertex AI (Google Cloud) adapter for Hairball Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Hairball to use Gemini models via Google Cloud with
...
# who installed plain `hairball-agent` and only later selected a Gemini model.
try:
