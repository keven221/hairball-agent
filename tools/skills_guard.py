...
Trust levels:
  - builtin:   Ships with Hairball. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hairball/\.env|\~/\.hairball/\.env',
     "hairball_env_access", "critical", "exfiltration",
     "directly references Hairball secrets file"),
    ...
    (r'\.hairball/config\.yaml|\.hairball/SOUL\.md',
     "hairball_config_mod", "critical", "persistence",
     "references Hairball configuration files directly"),
...
# scan. `.skillignore` is the Hairball-native name; `.clawhubignore` is honored
