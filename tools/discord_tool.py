...
Only included in the hairball-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Hairball-Agent (https://github.com/managed/hairball-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_hairball_home() / "cache" / "discord_capabilities.json"
