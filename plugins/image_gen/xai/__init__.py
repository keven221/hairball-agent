...
def _xai_image_field(source: str) -> Dict[str, str]:
    ...
    # (same boundary the OpenAI / OpenRouter / reference image providers apply).
...
class XAIImageGenProvider(ImageGenProvider):
    ...
    def get_setup_schema(self) -> Dict[str, Any]:
        ...
        # hook (``hairball_cli/tools_config.py``); identical to the TTS / video
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        storage_options = build_xai_storage_options(
            "image_gen",
            filename_prefix="hairball-xai-image",
            extension="png",
        )
