...
Config: ~/.hairball/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.hairball/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hairball_home()`` helper (HAIRBALL_HOME-aware and
...
RULES_FILE = get_hairball_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_hairball_home() / "feishu_comment_pairing.json"
