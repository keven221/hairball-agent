...
required — uses aiohttp which is already a Hairball dependency.
...
# practical limit for readable messages — matching legacy's choice).
...
def interactive_setup() -> None:
    ...
    ``hairball_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Hairball delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # hairball_cli/setup.py::_setup_mattermost function.
