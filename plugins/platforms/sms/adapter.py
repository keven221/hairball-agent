...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Hairball gateway adapter.

    Each inbound phone number gets its own Hairball session (multi-tenant).
...
# static dict in hairball_cli/gateway.py, and the _send_sms dispatch in
