...
``_check_spotify_available()`` — when the user has not run ``hairball auth
spotify``, the tools remain registered (so they appear in ``hairball
...
The Spotify auth flow (``hairball auth spotify``), CLI plumbing, and docs
