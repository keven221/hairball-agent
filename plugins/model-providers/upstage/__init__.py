...
# When the user hasn't picked a reasoning effort, Hairball passes
...
# ON at this effort — matching the "medium (default)" that Hairball' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Hairball' effort vocabulary onto Solar's accepted set. xhigh/max/
