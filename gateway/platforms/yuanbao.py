...
_APP_VERSION = _HAIRBALL_VERSION
_BOT_VERSION = _HAIRBALL_VERSION
_YUANBAO_INSTANCE_ID = str(HAIRBALL_INSTANCE_ID)  # single source: yuanbao_proto.HAIRBALL_INSTANCE_ID
...
class InboundPipeline:
    ...
    Inspired by legacy's MessagePipeline (extensions/yuanbao/src/business/
