...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$HAIRBALL_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_hairball_dir("platforms/whatsapp/session", "whatsapp/session")
